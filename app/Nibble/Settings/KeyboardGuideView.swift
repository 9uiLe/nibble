        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 28) {
                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    KeyboardGuideSection(title: "全文を確認する", text: "項目の「全文を見る」を押すと、本文を最後まで読めます。この操作では入力されません。「入力先へ入力」を押すと本文を挿入します。「クリップボードへコピー」は入力先へ送らず、あとで貼り付けられるようにします。")
                    KeyboardGuideSection(title: "一覧を使う", text: "「すべて」と「ピン留め」で表示する項目を選び、矢印で50件ずつ移動できます。nibbleで保存や編集をした内容は、キーボードを開くと読み込まれます。検索や編集はnibbleアプリで行います。")
                }
                Divider()
                VStack(alignment: .leading, spacing: 20) {
