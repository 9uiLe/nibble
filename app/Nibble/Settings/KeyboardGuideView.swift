    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                KeyboardGuideSection(title: "ほかのアプリで入力する", text: "nibbleキーボードで項目をタップすると、保存した本文を入力中のアプリに挿入できます。入力後は、そのアプリに反映されたか確認してください。下書きや削除した項目は表示されません。")
                ...
                KeyboardGuideSection(title: "全文を確認する", text: "項目の「…」を押すと、本文を最後まで読めます。この操作では入力されません。「入力する」を押すと本文を挿入します。")
