...
製品は端末内のSQLiteへ本文を保存し、同期・アカウント・分析を提供しない。[製品設計](../docs/decisions/0002-mvp-app.md)と[TestFlight手順](../docs/testflight.md)が実装と配布の正本である。以下の外部要件は2026-09-13に確認した判断材料で、提出時の最新要件や審査結果の保証ではない。
