...
MVPは端末内保存、Data Protectionのcomplete指定、端末内コピーを採用し、データ収集・tracking・第三者SDKを含まない。[製品設計](../docs/decisions/0002-mvp-app.md)と[MVPの検証結果](../docs/mvp-validation.md)に実装・確認範囲を定める。ロック時の実効性、署名配布、App Privacy回答、privacy policy、審査は個別の評価対象である。
