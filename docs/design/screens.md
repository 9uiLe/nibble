...
**確認条件**：権限なしの挿入と権限ありのコピー、本文の完全一致、ページ移動、削除・変更後の拒否、入力先変更・非表示中の完了を検証する。横向き、ライト・ダーク、長いタイトル、0件・51件以上で操作領域を保つ。[技術仕様](../decisions/0005-snippet-keyboard.md)がOS制約とデータの責務を定める。
