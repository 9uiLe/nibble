...
高さは既存の288pt・compact時196ptを維持する。OSが所有する地球儀・音声入力・セーフエリアを複製しない。操作領域は44pt以上、文字サイズ・太字・コントラストは本体と同じ固定表示を維持し、中央だけスクロールする。色・寸法・操作の契約は[キーボード設計](../decisions/0005-snippet-keyboard.md#レイアウトと操作の意味)に定義する。
...
**確認条件**：1タップ1挿入、「…」で0挿入、長文末尾、戻る位置、ピンの保存結果、原文、権限別操作、変更・削除拒否、ページ・更新・切替・終了、狭幅・縦横・ライト／ダーク・拡大文字・VoiceOverを確認する。
