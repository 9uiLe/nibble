...
標準キーボードの背景・余白・選択部品を使う外観は`c07902e25d5490ee4b1a1d78c63d15780a27e847`で評価した。ReleaseのiOS 26.5 Simulatorで縦横・ライト／ダーク、フィルター、権限別の挿入・コピーを確認し、画像と録画の抽出フレームをレビューした。[外観の検証](keyboard-validation.md#標準キーボードに合わせた外観)に対象runと未確認条件を記載する。この外観のTestFlight配布は未実施。
